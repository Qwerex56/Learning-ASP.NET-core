...
{
  // A DbSet<TEntity> can be used to query and save instances of Student. LINQ queries against a DbSet<TEntity> will be translated into queries against the database.
